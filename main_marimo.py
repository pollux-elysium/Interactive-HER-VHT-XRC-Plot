...
def _(mo, np):
    ...
    "f": mo.ui.slider(steps=np.linspace(0, 30, 101), value=0, label="F", show_value=True),
                    "BDFE": mo.ui.slider(steps=np.linspace(1.5, 3, 101), value=1., label="BDFE", show_value=True),
                    "log kva": mo.ui.slider(steps=np.linspace(-15, 15, 301), value=-1, label="Log kva", show_value=True),
                    "l va": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="λ va", show_value=True),
                    "b va": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="β va", show_value=True),
                    "log kvb": mo.ui.slider(steps=np.linspace(-15, 15, 301), value=-1, label="Log kvb", show_value=True),
                    "l vb": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="λ vb", show_value=True),
                    "b vb": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="β vb", show_value=True),
                    "log kt": mo.ui.slider(steps=np.linspace(-15, 15, 301), value=-1, label="Log kt", show_value=True),
                    "l t": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="λ t", show_value=True),
                    "log kha": mo.ui.slider(steps=np.linspace(-15, 15, 301), value=-1, label="Log kha", show_value=True),
                    "l ha": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="λ ha", show_value=True),
                    "b ha": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="β ha", show_value=True),
                    "log khb": mo.ui.slider(steps=np.linspace(-15, 15, 301), value=-1, label="Log khb", show_value=True),
                    "l hb": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="λ hb", show_value=True),
                    "b hb": mo.ui.slider(steps=np.linspace(0, 1, 101), value=0.5, label="β hb", show_value=True),
